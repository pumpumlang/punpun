...
def main():
 ...
 with tempfile.TemporaryDirectory() as td:
  ...
  runtime=[ROOT/'runtime/ppcrt.c',ROOT/'runtime/ppc_https.c',ROOT/'runtime/ppc_gui.c',ROOT/'runtime/ppc_net.c',ROOT/'runtime/ppc_platform_posix.c',ROOT/'runtime/ppc_platform_windows.c']
