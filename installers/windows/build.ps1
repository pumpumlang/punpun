...
if (!(Get-Command wix -ErrorAction SilentlyContinue)) { throw "WiX Toolset v6 'wix' is required." }
...
wix build "$PSScriptRoot\wix\Bundle.wxs" -ext WixToolset.BootstrapperApplications.wixext `
