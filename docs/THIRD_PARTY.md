...
- **Python 3**: currently required by the PPX beta client/registry and static website build scripts. It is not required by compiled PunPun applications or normal `pp build`/`pp run`.
