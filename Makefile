...
.PHONY: all compiler selfhost clean test install install-vscode
...
$(BUILD)/ppc: $(PPC_SOURCES) runtime/libpunpun.a | $(BUILD)
	$(CXX) $(CXXFLAGS) -DPP_RUNTIME_DIR='"runtime"' compiler/main.cpp -o $@
